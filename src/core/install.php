<?php
  if ( ! defined('_INCLUDED_') ) exit('NO F*CKING DIRECT SCRIPT ACCESS ALLOWED LOL');

  abstract class install {
    protected var $tablePrefix;
    protected var $dbHost;
    protected var $dbPort;
    protected var $dbName;
    protected var $dbPassword;
